...
// var directionsService = new google.maps.DirectionsService();
// google.maps.event.addDomListener(window, 'load', function () {
    // new google.maps.places.SearchBox(document.getElementsByClassName('startDestination'));
    // new google.maps.places.SearchBox(document.getElementsByClassName('endDestination'));
    // directionsDisplay = new google.maps.DirectionsRenderer({ 'draggable': true });
// });
...
// function GetRoute() {
    ...
    // //*********DIRECTIONS AND ROUTE**********************//
    // source = document.getElementsByClassName('startDestination').value;
    // destination = document.getElementsByClassName('startDestination').value;
